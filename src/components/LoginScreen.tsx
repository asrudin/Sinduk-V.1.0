  ...
  return (
    <div id="login-container" className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4 relative overflow-hidden select-none text-slate-100">
      ...
      <div className="absolute inset-0 z-0 opacity-40 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[10%] w-[30%] h-[40%] bg-indigo-600 rounded-full blur-[100px]"></div>
      </div>

      <div className="w-full max-w-md glass-card p-6 md:p-8 shadow-2xl relative z-10 rounded-2xl border border-white/10">
        <div className="flex flex-col items-center mb-8">
          <div className="h-12 w-12 rounded-xl bg-indigo-500/10 border border-indigo-500/30 flex items-center justify-center mb-3 text-indigo-400 shadow-md shadow-indigo-500/10">
            <GraduationCap className="h-6 w-6" />
          </div>
          <h1 className="text-xl font-bold text-white tracking-tight">Buku Induk Siswa Digital</h1>
          <p className="text-[10px] text-indigo-400 font-bold uppercase tracking-wider mt-1">Portal Administrasi & Arsip Akademik Sekolah</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/5">
          <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-3">Akun Pendidik & Staf Demo:</p>
