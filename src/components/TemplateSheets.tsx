  ...
  return (
    <div className="space-y-6 z-10 relative">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-0.5 font-medium">Salin template struktur spreadsheet, Apps Script, dan portal web untuk integrasi eksternal</p>
      </div>
      ...
      <div className="bg-indigo-500/10 border border-indigo-500/20 p-5 rounded-2xl text-xs text-indigo-200 leading-relaxed space-y-2">
        ...
        <ol className="list-decimal list-inside space-y-1.5 pl-1 text-indigo-200/90">
          ...
          <li>Buat sheet-sheet bernama <span className="font-mono bg-indigo-500/20 text-indigo-300 px-1 py-0.5 rounded font-bold">Daftar_Siswa</span>, dan <span className="font-mono bg-indigo-500/20 text-indigo-300 px-1 py-0.5 rounded font-bold">Catatan_Siswa</span> sesuai dengan struktur kolom di tab di bawah.</li>
      ...
      <div className="border-b border-white/5">
        <div className="flex gap-4">
          ...
          >
            ...
            index.html (Portal View)
          </button>
        </div>
      </div>

      {/* Code Area Wrapper */}
      <div className="glass-card rounded-2xl overflow-hidden shadow-lg flex flex-col relative border border-white/10">
        ...
        <div className="p-3 bg-slate-950/40 border-b border-white/10 flex justify-between items-center text-[10px] text-slate-400 font-mono">
          <span>{activeTab === 'sheet' ? 'REKOMENDASI KOLOM SPREADSHEET' : activeTab === 'gs' ? 'GOOGLE APPS SCRIPT FILE' : 'EMBEDDED PORTAL'}</span>
